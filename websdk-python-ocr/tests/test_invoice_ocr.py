...
class TestInvoiceOCRClient:
    ...
    @patch('xfyunsdkocr.invoice_ocr_client.InvoiceOCRClient.post')
    def test_send_method_exists(self, mock_post):
        ...
        # 调用 send 方法
        result = client.identify("base64_encoded_image", "1", InvoiceTypeEnum.BANK_CARD)
