...
from xfyunsdkocr.image_word_client import ImageWordOCRClient


class TestImageWordOCRClient:
    """图像文字识别客户端测试类"""
    ...
    @patch('xfyunsdkocr.image_word_client.ImageWordOCRClient.post')
    def test_send_method_exists(self, mock_post):
        ...
        # 调用 send 方法
        result = client.send("base64_encoded_image", "jpg")
