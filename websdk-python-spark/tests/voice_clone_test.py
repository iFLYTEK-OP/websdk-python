...
def stream():
    ...
    try:
        # 初始化客户端
        client = VoiceCloneClient(
            app_id="ab5552d9",  # 替换为你的应用ID
            api_key="5be11b4a20b5b82e56e631060470f47b",  # 替换为你的API密钥
            api_secret="NGVlYTAyZWQ3MDhlOTdhNWIyOTQwOTJj",  # 替换为你的API密钥
            res_id="a0b5e93_ttsclone-ab5552d9-ierkq",
            # callback=PrintCallback(),  # 使用回调处理音频块
            rhy=1
        )
